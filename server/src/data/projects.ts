...
export const projectsData: Project[] = [
  {
    ...
    title: 'Apex-10: 1/10 Scale 4WD High-Speed Brushless RC Chassis',
    tagline: 'Custom carbon-fiber & CNC aluminum chassis designed for high-grip asphalt and sprint racing.',
    category: 'RC Cars',
    year: 2026,
    featured: true,
    status: 'Operational',
    ...
    circuitDiagramUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1000&q=80',
    buildProcess: [
    ...
    teamMembers: [
      { name: '[Team Member 1]', role: 'Mechanical & Suspension Lead' },
      { name: '[Team Member 2]', role: 'Powertrain & ESC Integration' },
      { name: '[Team Member 3]', role: 'Telemetry Firmware & Telemetry' }
    ],
    specsSummary: {
      topSpeed: '78.4 km/h',
    ...
    githubRepo: 'https://github.com/rtist-nitj/apex10-telemetry-firmware'
  },
  {
    id: 'proj-02',
    ...
    overview: 'TITAN-X is an autonomous 3kg SumoBot built for maximum traction, aggressive wedge geometry, and split-second edge detection on standard 154cm steel Dohyo rings. Powered by 24V brushed DC motors producing 18 Nm peak stall torque.',
    ...
    circuitDiagramUrl: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=1000&q=80',
    buildProcess: [
    ...
    teamMembers: [
      { name: '[Team Member 1]', role: 'Mechanical & Wedge Geometry' },
      { name: '[Team Member 2]', role: 'Embedded Systems & STM32 Firmware' },
      { name: '[Team Member 3]', role: 'Power Electronics & Sensors' }
    ],
    specsSummary: {
      topSpeed: '3.4 m/s',
  ...
  },
  {
    ...
    thumbnailUrl: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?auto=format&fit=crop&w=1000&q=80',
  ...
  },
  {
    ...
    featured: false,
    status: 'Operational',
    thumbnailUrl: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=1000&q=80',
